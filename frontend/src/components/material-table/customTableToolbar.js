            ...
            {numSelected > 0 ?
                ...
                <Fragment>
                                ...
                                endAdornment={inputText !== "" ?
                                    <InputAdornment position="end">
                                        <Tooltip title="Cancelar búsqueda">
                                            <IconButton onClick={onCancelarBusqueda} color="secondary" size="large">
                                                <ClearRoundedIcon />
                                            </IconButton>
                                        </Tooltip>
                                    </InputAdornment> : null
                    ...
                    <Tooltip title="Buscar">
                        <IconButton color="secondary" onClick={() => handleShowSearch(true)} size="large">
                            <SearchRoundedIcon />
                        </IconButton>
                    </Tooltip>
