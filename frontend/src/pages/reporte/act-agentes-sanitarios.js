...
function Page() {
    ...
    const handleDescargar = async (values, { resetForm }) => {
        ...
        const response = await postData("reporte/act-agente-sanitario.php", {
    ...
    return (
        <Layout nombrePagina="Reporte de la Actividad de Agentes Sanitarios">
            <Fade in={true} timeout={900}>
                <Grid item xs={12}>
                    <Paper className={classes.paper}>
                        <p>
                            En este reporte se puede verificar las actividades de los agentes sanitarios.
