...
function Page() {
    ...
    const handleDescargar = async (values, { resetForm }) => {
        ...
        const response = await postData("reporte/faltantes.php", {
    ...
    return (
        <Layout nombrePagina="Reporte de Faltantes">
            <Fade in={true} timeout={900}>
                <Grid item xs={12}>
                    <Paper className={classes.paper}>
                        <p>
                            En este reporte se puede verificar la información faltante por establecimiento.
                            Esta falta puede ser por estar sin cargar, o por estar cargado y pendiente de supervisar. <br></br>
