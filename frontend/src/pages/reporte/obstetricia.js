...
function Page() {
    ...
    const handleDescargar = async (values, { resetForm }) => {
        ...
        const response = await postData("reporte/obstetricia.php", {
    ...
    return (
        <Layout nombrePagina="Reporte de las Atenciones de Obstetricia">
            <Fade in={true} timeout={900}>
                <Grid item xs={12}>
                    <Paper className={classes.paper}>
                        <p>
                            En este reporte se puede verificar las atenciones de obstetricia de cada establecimiento.
