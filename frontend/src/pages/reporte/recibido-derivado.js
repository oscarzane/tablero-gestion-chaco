...
function Page() {
    ...
    const handleDescargar = async (values, { resetForm }) => {
        ...
        const response = await postData("reporte/recibido-derivado.php", {
    ...
    return (
        <Layout nombrePagina="Reporte de Pacientes Recibidos y Derivados">
            <Fade in={true} timeout={900}>
                <Grid item xs={12}>
                    <Paper className={classes.paper}>
                        <p>
                            En este reporte se puede verificar los pacientes recibidos y derivados de cada establecimiento.
