...
function Page() {
    ...
    const handleDescargar = async (values, { resetForm }) => {
        ...
        const response = await postData("reporte/consultorio-externo.php", {
    ...
    return (
        <Layout nombrePagina="Reporte de Consultas Médicas en Consultorio Externo">
            <Fade in={true} timeout={900}>
                <Grid item xs={12}>
                    <Paper className={classes.paper}>
                        <p>
                            En este reporte se puede verificar las consultas médicas atendidas en consultorios externos.
