...
function Page() {
    ...
    const handleDescargar = async (values, { resetForm }) => {
        ...
        const response = await postData("reporte/trabajo-social.php", {
    ...
    return (
        <Layout nombrePagina="Reporte de las actividades en trabajo social">
            <Fade in={true} timeout={900}>
                <Grid item xs={12}>
                    <Paper className={classes.paper}>
                        <p>
                            En este reporte se puede verificar las actividades en trabajo social de cada establecimiento.
