...
function Page() {
    ...
    const handleDescargar = async (values, { resetForm }) => {
        ...
        const response = await postData("reporte/establecimientos.php", {
    ...
    return (
        <Layout nombrePagina="Reporte de establecimientos">
            <Fade in={true} timeout={900}>
                <Grid item xs={12}>
                    <Paper className={classes.paper}>
                        <p>
                            En este reporte se puede verificar los establecimientos activos y sus características.
