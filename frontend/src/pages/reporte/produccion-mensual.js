...
function Page() {
    ...
    const handleDescargar = async (values, { resetForm }) => {
        ...
        const response = await postData("reporte/produccion-mensual.php", {
    ...
    return (
        <Layout nombrePagina="Reporte de la Producción Mensual">
            <Fade in={true} timeout={900}>
                <Grid item xs={12}>
                    <Paper className={classes.paper}>
                        <p>
                            En este reporte se puede verificar la producción mensual de cada establecimiento.
