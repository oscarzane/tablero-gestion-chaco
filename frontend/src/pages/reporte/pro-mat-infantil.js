...
function Page() {
            ...
            fields: [
                {
                    ...
                    validationSchema: yup.number().required().positive().min(2022).max(3000),
                },
                usuario.admin * 1 == 1 || usuario.revisor * 1 == 1 || usuario.solo_region * 1 > 0 ? {
                    ...
                    disabled: usuario.admin * 1 != 1 && usuario.revisor * 1 != 1,
                } : "",
                usuario.admin * 1 == 1 || usuario.revisor * 1 == 1 || usuario.solo_region * 1 > 0 ? {
    ...
    const handleDescargar = async (values, { resetForm }) => {
        ...
        const response = await postData("reporte/pro-mat-infantil.php", {
            id_usuario: usuario.id_usuario,
            ano: values.ano,
            region: values.region ? values.region : 0,
    ...
    return (
        <Layout nombrePagina="Reporte del Programa Materno Infantil">
            <Fade in={true} timeout={900}>
                <Grid item xs={12}>
                    <Paper className={classes.paper}>
                        <p>
                            En este reporte se puede verificar el estado, al último mes informado por cada establecimiento, del programa materno infantil.
