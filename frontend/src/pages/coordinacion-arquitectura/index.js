...
function Page() {
    ...
    const iframeUrl = "https://app.powerbi.com/view?r=eyJrIjoiMWRjZGI2MjktMTBhNC00YzFhLWE0N2MtNzI5NmU3YTlkYThjIiwidCI6ImQ5ZGMxNmQ2LWU3MWUtNGUxNi1hYTEyLWQ1OGY3ZDVmZDE5ZiJ9";

    return (
        <Layout nombrePagina="Coordinación presupuestaria y financiera">
            <Fade in={true} timeout={900}>
                <Grid item xs={12}>
                    <h1>Arquitectura hospitalaria</h1>
