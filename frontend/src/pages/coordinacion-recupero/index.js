    ...
    return (
        <Layout nombrePagina="Coordinación presupuestaria y financiera">
            <Fade in={true} timeout={900}>
                <Grid item xs={12}>
                    <h1>Recupero de gastos</h1>

                    <Paper className={classes.paper}>
                        <div className={classes.warningMensaje}>
                            <WarningRoundedIcon color="warning" />
                            <p>No tienes permiso para acceder a este tablero. Para solicitar acceso comunicarse a tablerosalud@chaco.gob.ar</p>
                        </div>
                    </Paper>
                </Grid>
            </Fade>
