    ...
    var t_return = [
        {
            ...
            data: [
                {
                    id: "0dias",
                    data: parseInt(p_formValues["dias"])
                },
            ]
        },
        {
            ...
            data: [
                {
                    id: "1horas",
                    data: parseInt(p_formValues["horas"])
                },
            ]
        },
        {
            ...
            data: [
                {
                    id: "2atenTotal",
                    data: parseInt(p_formValues["atenPrimera"]) + parseInt(p_formValues["atenUlterior"]),
                },
            ]
        },
        {
            id: 3,
            title: "Captaciones de Emb.",
            data: [
                {
                    id: "3captaTotal",
                    data: parseInt(p_formValues["captaMen13"]) + parseInt(p_formValues["captaMen28"]) + parseInt(p_formValues["captaMas29"]),
                },
            ]
        },
        {
            ...
            data: [
                {
                    id: "4controTotal",
                    data: parseInt(p_formValues["controEmb"]) + parseInt(p_formValues["controPuerp"]),
                },
            ]
        },
        {
            ...
            data: [
                {
                    id: "5pracTotal",
                    data: parseInt(p_formValues["pracExud"]) + parseInt(p_formValues["pracPap"]),
                },
            ]
        },
        {
            id: 6,
            title: "Act. de Prevención",
            data: [
                {
                    id: "6prevTotal",
                    data: parseInt(p_formValues["prevProm"]) + parseInt(p_formValues["prevPrep"]) + parseInt(p_formValues["prevProc"]),
                },
            ]
        },
        {
            id: 7,
            title: "Partos atendidos",
            data: [
                {
                    id: "7partos",
                    data: parseInt(p_formValues["partos"])
                },
            ]
        },
        {
            id: 8,
            title: "Recién nacidos recib.",
            data: [
                {
                    id: "8nacRecib",
                    data: parseInt(p_formValues["nacRecib"])
                },
            ]
        },
    ];
...
function Page() {
    ...
    const onSubmitFinal = async () => {
        ...
        const response = await postFiles(data ? "obstetricia/editar.php" : "obstetricia/nuevo.php", {
            id_usuario: usuario.id_usuario,
            id_obstetricia: data ? data.id_obstetricia : false,
    ...
    return (
        <Fragment>
            <Layout nombrePagina={data ? "Corrección de Atenciones de Obstetricia" : "Nuevo Informe de Atenciones de Obstetricia"}>
