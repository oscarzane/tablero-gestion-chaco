...
function Page() {
    ...
    const onSubmitFinal = async (values) => {
        ...
        const response = await postFiles(data ? "enfermeria/editar.php" : "enfermeria/nuevo.php", {
            id_usuario: usuario.id_usuario,
            id_enfermeria: data ? data.id_enfermeria : false,
    ...
    return (
        <Fragment>
            <Layout nombrePagina={data ? "Corrección de Prest. de Enfermería" : "Nuevo Informe de Prest. de Enfermería"}>
