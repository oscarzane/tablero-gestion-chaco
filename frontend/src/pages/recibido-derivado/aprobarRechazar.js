...
function Page() {
    ...
    const onSubmitFinal = async () => {
        ...
        const response = await postFiles("recibido-derivado/revisar.php", {
            id_usuario: usuario.id_usuario,
            id_recibido_derivado: data.id_recibido_derivado,
            ...formValues
        });
        if (response.error === "") {
    ...
    const formSections = useMemo(() => [
        ...
        },
        {
            ...
            description: "Revisa los pacientes recibidos y derivados. Puedes ver más detalles haciendo clic en cada uno.",
            fields: [
                {
    ...
    return (
        <Fragment>
            <Layout nombrePagina={"Aprobar / Rechazar P. Recibidos y Derivados"}>
